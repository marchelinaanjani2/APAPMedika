package apap.ti.hospitalization2206082770.security.jwt;
...
public class JwtUtils {
    ...
    @Value("${hospitalization2206082770.app.jwtSecret}")
    private String jwtSecret;

    @Value("${hospitalization2206082770.app.jwtExpirationMs}")
